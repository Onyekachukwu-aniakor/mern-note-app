...
const Login = () => {
    ...
    const handleSubmit =async(e) =>{
        e.preventDefault();
        try {
           const response = await axios.post('https://mern-note-app-sqi8.onrender.com/api/auth/login', {email,password}); 
  ...
  return (
    <div className='flex justify-center items-center min-h-screen bg-gray-100 bg-gray-100  bg-gradient-to-br from-blue-200 to-purple-400 '>
